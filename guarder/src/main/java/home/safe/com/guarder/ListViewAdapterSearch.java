...
public class ListViewAdapterSearch extends ArrayAdapter {
    ...
    ListViewAdapterSearch(Context context, int resource, ArrayList<ListViewItemSearch> list, ListBtnClickListener clickListener) {
    ...
    private ArrayList<ListViewItemSearch> lvitemSearch = new ArrayList<ListViewItemSearch>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ListViewItemSearch listViewItemSearch = (ListViewItemSearch) getItem(position);

        tvName.setText(listViewItemSearch.getTvName());
        tvPhone.setText(listViewItemSearch.getTvPhone());

        // btnSearchAdd 클릭 시 작업내용
        Button btnSearchAdd = (Button) convertView.findViewById(R.id.btnSearchAdd);
